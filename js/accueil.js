    ...
    function renderHome() {
      ...
      app.innerHTML = `
        ...
        <section class="xs-gallery">
          <div class="xs-gallery-viewport" id="xs-gallery-viewport">
            <div class="xs-gallery-track" id="xs-gallery-track"></div>
          </div>
          <div class="xs-gallery-nav">
            <div class="xs-gallery-progress" id="xs-gallery-progress">
              <div class="xs-gallery-progress-fill" id="xs-gallery-progress-fill"></div>
            </div>
            <div class="xs-gallery-arrows">
              <button type="button" class="xs-gallery-arrow" id="xs-gallery-prev" aria-label="Précédent">
                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                  <path d="M15 5L8 12L15 19" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </button>
              <button type="button" class="xs-gallery-arrow" id="xs-gallery-next" aria-label="Suivant">
                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
